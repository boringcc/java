package myhrm.controller;

import myhrm.domain.User;
import myhrm.service.HrmService;
import myhrm.util.common.HrmConstants;
import myhrm.util.tag.PageModel;
...
public class DocumentController {
	...
	/**
	 * 处理添加请求
	 *  String flag 标记， 1表示跳转到上传页面，2表示执行上传操作
	 *    Notice notice  要添加的公告对象
	 *    ModelAndView mv
	 * */
