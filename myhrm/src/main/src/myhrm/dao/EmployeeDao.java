...
import myhrm.dao.provider.EmployeeDynaSqlProvider;
...
import static myhrm.util.common.HrmConstants.EMPLOYEETABLE;
...
public interface EmployeeDao {
	...
	@Results({
		...
		@Result(column="DEPT_ID",property="dept",
			one=@One(select="myhrm.dao.DeptDao.selectById",
		fetchType=FetchType.EAGER)),
		@Result(column="JOB_ID",property="job",
			one=@One(select="myhrm.dao.JobDao.selectById",
		fetchType=FetchType.EAGER))
	})
